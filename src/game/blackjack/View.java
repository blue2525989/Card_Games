...
public class View {
	...
	// main frame 
	public JFrame main = new JFrame("BlackJack");
	...
	// fun header
	private JLabel header = new JLabel("Play Black Jack! choose an option,");
	// prompt
	private JTextArea middleText = new JTextArea("The computer will hit untill 17\n"
			+ "Written by, Jason Bierbrauer\n"
			+ "Enjoy!",
			10,40);
